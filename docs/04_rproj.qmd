...
- Identifies the project root (i.e., the directory containing the `.Rproj` file) as the working directory
    ...
    - Even if you do not open the `.Rproj` file, functions like `here::here()` may find the project root by searching for `.Rproj`.
