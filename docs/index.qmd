...
+============+======================+========================================+==========================================+
| **SAS**    | - Proprietary\       | - Reputation for regulatory\           | - Expensive\                             |
|            | - Paid               |   compliance\                          | - Rigid\                                 |
|            |                      | - Standardized procedures\             | - Not as extensible                      |
|            |                      | - Rigorously tested\                   |                                          |
|            |                      | - Vendor handles updates,\             |                                          |
|            |                      |   documentation, and support           |                                          |
+------------+----------------------+----------------------------------------+------------------------------------------+
| **R**      | - Open source\       | - Accessible\                          | - Might not be as rigorously tested\     |
|            | - Free               | - Flexible\                            | - Dependencies may be at different\      |
|            |                      | - Extensible\                          |   stages of development\                 |
|            |                      | - Rich community contributions         | - Companies bear responsibility for\     |
