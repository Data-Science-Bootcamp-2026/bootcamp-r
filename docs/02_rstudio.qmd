...
|---------|-------|---------|
| [Panes (below)](02_rstudio.md#panes) | - Console<br>- Editor (separate window)<br>- Plots/help (separate window) | - Console<br>- Editor<br>- Plots/help<br>- Environment |
| Syntax highlighting | ~ | ✓ |
| Code completion | ~ | ✓ |
| Debugger | ~ | ✓ |
| Package manager | ~ | ✓ |
| [R projects](04_rproj.md) | ✗ | ✓ |
| Git integration* | ✗ | ✓ |
| R markdown support* | ✗ | ✓ |
| Quarto support* | ✗ | ✓ |
...
![Environment pane: browse objects created in your workspace, R history, Git integration, etc.](assets/images/rstudio_env.png)

![Other pane: browse files, view plots, manage packages, view help, etc.](assets/images/rstudio_other.png)
...
3. Uncheck **Restore .Rdata into workspace ta startup:**
