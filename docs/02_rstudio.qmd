...
+----------------------------------------+----------------------------------+----------------------------------+
| [R projects](03_rproj.qmd)             | $\times$                         | $\checkmark$                     |
+----------------------------------------+----------------------------------+----------------------------------+
...
![Editor pane: write reusable scripts, and can view data structures (latter is not shown in image)](assets/images/rstudio_editor.png)
