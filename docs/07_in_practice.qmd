...
::: {.callout-caution}
## **Caution**
Different data formats denote missing data differently. In CSV, missingness is just blank. In Excel, missingness appears as an empty cell. In SAS, missingness is `.` (if numeric) or blank (if categorical). In R, missingness is `NA`.
:::
